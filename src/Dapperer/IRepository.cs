...
namespace Dapperer
{
        ...
        where TEntity : class, IIdentifier<TPrimaryKey>, new() 
    {
        ...
        IEnumerable<TEntity> CreateBatchWithOutput(IEnumerable<TEntity> entities);
        IEnumerable<TEntity> CreateBatchWithOutput(IEnumerable<TEntity> entities, bool identityInsert);
        ...
        Task<IEnumerable<TEntity>> CreateBatchWithOutputAsync(IEnumerable<TEntity> entities);
        Task<IEnumerable<TEntity>> CreateBatchWithOutputAsync(IEnumerable<TEntity> entities, bool identityInsert);
