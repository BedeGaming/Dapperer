...
namespace Dapperer
{
        ...
        where TEntity : class, IIdentifier<TPrimaryKey>, new()
    {
        ...
        protected async Task<Page<TEntity>> PageAsync(int skip, int take, string filterQuery, object filterParams = null, string fromQuery = null, string orderByQuery = null, ICollection<string> additionalTableColumns = null)
        {
